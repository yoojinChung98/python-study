...
# 리턴은 한 번 뿐~ (여러개 보내고 싶으면 뭔가에 싸서 보내새용)
def operate_all(n1, n2):
    return n1 + n2, n1-n2, n1*n2, n1/n2 # tuple로 싸서 보냄.
    # return n1 - n2
    # return n1 * n2
    # return n1 / n2
...
# return 이 없는 void 타입이면 머 그냥 return 만 생략하면 댐ㅎㅎ => None 기본 타입 이 반환됨.
def multi(n1, n2):
    result = n1 * n2
