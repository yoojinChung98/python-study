...
import time as t
print(t.time()) # java 에서 제공하는 currentTimeMillis 와 유사.
...
크롤링 할 때 필요 (페이지가 로딩이 되어야 값을 가져올 수 있으므로.)
'''
'''
print("재밌는 문제를 준비했어용~~")
t.sleep(5)
...
print(f'지금은 {d.year}년 {d.month}월 {d.day}일 {d.hour}시 {d.minute}분 {d.second}초')
